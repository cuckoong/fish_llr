...
'''
Generate the swimming distance  from raw data for statistical analysis on light-induced locomotor response
'''

os.chdir('/Users/panpan/PycharmProjects/old_project/fish_llr/')
if __name__ == '__main__':
    days = [5, 6, 7, 8]
    activity_type = ['smldist', 'lardist'] # all swimming distance or only one type of activity
    fish_type = 'Tg'
    radiation = 1.2
    plates = [1]
    hour = 60
    ...
    res_dir = 'Processed_data/Tracking/Tg/stat_data/'
